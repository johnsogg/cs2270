...
public interface SortingIntf {
     ...
     * brain-damage. All Java objects are passed by _reference_, which
     * means whatever you do to this vector inside the quicksort function
     * will be visible outside as well.
     *
     ...
     **/
    void quicksort(List<Integer> data, int low_idx, int high_idx);
     ...
     **/
    void mystery_sort(List<Integer> data);
